...
@section("title", "Master Kecamatan - Data Master")
...
<style>
    #kecamatanTable th { white-space: nowrap; }
    #kecamatanTable td { vertical-align: middle; padding: 8px 10px; }
    .card-tools {
        display: flex;
        gap: 0.5rem;
        flex-wrap: wrap;
    ...
    #kecamatanTable .badge.badge-success {
        background-color: #dff3e1 !important;
        color: #2e7d32 !important;
        border: 1px solid #c8e6c9;
    }
    #kecamatanTable .badge.badge-danger {
    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Data Master &raquo; Manajemen Kecamatan</h3>
                <div class="card-tools">
                    <a href="{{ route('master.kecamatan.create') }}" class="btn btn-success btn-sm">
                    ...
                    <div class="input-group input-group-sm ml-2" style="width: 220px;">
                        ...
                        <input type="text" id="searchBox" class="form-control" placeholder="kata kunci pencarian" aria-controls="kecamatanTable">
                    </div>
                </div>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <div class="table-responsive">
                    <table id="kecamatanTable" class="table table-bordered table-striped table-hover">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th width="120" class="text-center">Kode Kecamatan</th>
...
<script>
    $(function () {
        var table = $('#kecamatanTable').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "{{ route('master.kecamatan.grid') }}",
                "type": "GET",
            ...
            "columns": [
                ...
                { "data": "kode_kecamatan", "className": "text-center" },
                { "data": "kode_kecamatan_nasional", "className": "text-center" },
                { "data": "nama_kecamatan" },
                { "data": "nama_kabupaten" },
                {
                    "data": "status_kecamatan",
                    "className": "text-center",
                ...
                },
                {
                    ...
                    "width": "90",
                    "render": function (data) {
                        var editUrl = '{{ url("admin/master/kecamatan/edit") }}/' + data;
                        var deleteUrl = '{{ url("admin/master/kecamatan/delete") }}/' + data;
        ...
        $('#kecamatanTable tbody').on('change', '.checkItem', function () {
            var id = $(this).val();
            if (this.checked) {
                selectedIds.add(id);
            } else {
        ...
        $('#checkAll').on('change', function () {
            ...
            $('#kecamatanTable tbody .checkItem').prop('checked', isChecked);
            syncCheckAllState();
        });

        // Terapkan ulang status pilihan setelah DataTables redraw
        table.on('draw', function () {
            $('#kecamatanTable tbody .checkItem').each(function () {
                var id = $(this).val();
        ...
        $('#btnConfirmHapus').on('click', function () {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('master.kecamatan.delete') }}",
