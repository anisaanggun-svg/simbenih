...
@section("title", "Tambah Master Kabupaten - Data Master")
    ...
    <div class="col-md-8 offset-md-2">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Form Input Data Master Kabupaten</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                @if($errors->any())
                ...
                <div class="info mb-3">
                    <p class="text-muted">User melakukan pengisian form untuk menambah data kabupaten.</p>
                </div>
                ...
                <form action="{{ route('master.kabupaten.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <select name="satgas" id="satgas"
                            ...
                            <option value="0" {{ old('satgas', '0') == '0' ? 'selected' : '' }}>-- Pilih Satgas --</option>
                            @foreach(\App\Models\Kabupaten::satgasOptions() as $key => $label)
                                <option value="{{ $key }}" {{ old('satgas') == $key ? 'selected' : '' }}>{{ $label }}</option>
                            @endforeach
                        </select>
                        @error('satgas')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="kode_satkab" id="kode_satkab"
                               ...
                               value="{{ old('kode_satkab') }}"
                               maxlength="10" placeholder="Contoh: 101, 102" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="kode_kabupaten_nasional" id="kode_kabupaten_nasional"
                               ...
                               value="{{ old('kode_kabupaten_nasional') }}"
                               maxlength="10" placeholder="Contoh: 78, 15" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_kabupaten" id="nama_kabupaten"
                               ...
                               placeholder="Contoh: Surabaya, Malang" required>
                    ...
                    <div class="form-group">
                        ...
                        <select name="status_kabupaten" id="status_kabupaten"
                            ...
                            <option value="1" {{ old('status_kabupaten', '1') == '1' ? 'selected' : '' }}>Aktif</option>
                            <option value="0" {{ old('status_kabupaten') == '0' ? 'selected' : '' }}>Tidak Aktif</option>
                        </select>
