...
@section("title", "Tambah Master Konfigurasi User - Data Master")
    ...
    <div class="col-md-8 offset-md-2">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Form Input Data Master Konfigurasi User</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                @if($errors->any())
                ...
                <div class="info mb-3">
                    <p class="text-muted">User melakukan pengisian form untuk menambah data konfigurasi user.</p>
                </div>
                ...
                <form action="{{ route('master.konfigurasi-user.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_konfigurasi" id="nama_konfigurasi"
                               ...
                               value="{{ old('nama_konfigurasi') }}"
                               maxlength="255" placeholder="Contoh: tahun, satgas, Otomatisasi no asal" required>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="nilai_konfigurasi" id="nilai_konfigurasi" rows="4"
                                  ...
                                  placeholder="Contoh: 2026, Surabaya, false">{{ old('nilai_konfigurasi') }}</textarea>
