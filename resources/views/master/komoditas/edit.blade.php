...
@section("title", "Edit Master Golongan - Data Master")
    ...
    <div class="col-md-8 offset-md-2">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Form Edit Data Master Golongan</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                @if($errors->any())
                ...
                <div class="info mb-3">
                    <p class="text-muted">User melakukan pengisian form untuk mengubah data golongan</p>
                </div>
                ...
                <form action="{{ route('master.komoditas.update', $komoditas->id) }}" method="POST">
                    @csrf
                    <input type="hidden" name="kode_hidden" value="{{ $komoditas->kode_komoditas }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="kode_komoditas" id="kode_komoditas"
                               ...
                               value="{{ old('kode_komoditas', $komoditas->kode_komoditas) }}"
                    ...
                    <div class="form-group">
                        ...
                        <select name="status_komoditas" id="status_komoditas"
                            ...
                            <option value="1" {{ old('status_komoditas', $komoditas->status_komoditas) == '1' ? 'selected' : '' }}>Aktif</option>
                            <option value="0" {{ old('status_komoditas', $komoditas->status_komoditas) == '0' ? 'selected' : '' }}>Tidak Aktif</option>
                        </select>
