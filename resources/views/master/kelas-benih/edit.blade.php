...
@section("title", "Edit Master Kelas Benih - Data Master")
    ...
    <div class="col-md-8 offset-md-2">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Form Edit Data Master Kelas Benih</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                @if($errors->any())
                ...
                <div class="info mb-3">
                    <p class="text-muted">User melakukan pengisian form untuk mengubah data kelas benih.</p>
                </div>
                ...
                <form action="{{ route('master.kelas-benih.update', $kelasBenih->id) }}" method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="kode_kb" id="kode_kb"
                               ...
                               value="{{ old('kode_kb', $kelasBenih->kode_kb) }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_kb" id="nama_kb"
                               ...
                               value="{{ old('nama_kb', $kelasBenih->nama_kb) }}"
                    ...
                    <div class="form-group">
                        ...
                        <select name="grup_kelas_benih_id" id="grup_kelas_benih_id"
                            ...
                            @foreach($grupKelasBenihList as $grup)
                                <option value="{{ $grup->id }}" {{ old('grup_kelas_benih_id', $kelasBenih->grup_kelas_benih_id) == $grup->id ? 'selected' : '' }}>
                    ...
                    <div class="form-group">
                        ...
                        <select name="status_kelas_benih" id="status_kelas_benih"
                            ...
                            <option value="1" {{ old('status_kelas_benih', $kelasBenih->status_kelas_benih) == '1' ? 'selected' : '' }}>Aktif</option>
                            <option value="0" {{ old('status_kelas_benih', $kelasBenih->status_kelas_benih) == '0' ? 'selected' : '' }}>Tidak Aktif</option>
                        </select>
