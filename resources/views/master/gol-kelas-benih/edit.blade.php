...
@section("title", "Edit Master Gol Kelas Benih - Data Master")
    ...
    <div class="col-md-8 offset-md-2">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Form Edit Data Master Gol Kelas Benih</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                @if($errors->any())
                ...
                <div class="info mb-3">
                    <p class="text-muted">User melakukan pengisian form untuk mengubah data gol kelas benih.</p>
                </div>
                ...
                <form action="{{ route('master.gol-kelas-benih.update', $golKelasBenih->id) }}" method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="kode_grup_kelas_benih" id="kode_grup_kelas_benih"
                               ...
                               value="{{ old('kode_grup_kelas_benih', $golKelasBenih->kode_grup_kelas_benih) }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_grup_kelas_benih" id="nama_grup_kelas_benih"
                               ...
                               value="{{ old('nama_grup_kelas_benih', $golKelasBenih->nama_grup_kelas_benih) }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="digit" id="digit"
                               ...
                               value="{{ old('digit', $golKelasBenih->digit) }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="warna_label" id="warna_label"
                               ...
                               value="{{ old('warna_label', $golKelasBenih->warna_label) }}"
                    ...
                    <div class="form-group">
                        ...
                        <select name="status_grup" id="status_grup"
                            ...
                            <option value="1" {{ old('status_grup', $golKelasBenih->status_grup) == '1' ? 'selected' : '' }}>Aktif</option>
                            <option value="0" {{ old('status_grup', $golKelasBenih->status_grup) == '0' ? 'selected' : '' }}>Tidak Aktif</option>
                        </select>
                        @error('status_grup')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
