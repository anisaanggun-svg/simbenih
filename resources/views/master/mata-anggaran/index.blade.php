...
@section("title", "Master M. Anggaran - Data Master")
...
<style>
    #mataAnggaranTable th { white-space: nowrap; }
    #mataAnggaranTable td { vertical-align: middle; padding: 8px 10px; }
    .card-tools {
        display: flex;
        gap: 0.5rem;
        flex-wrap: wrap;
    ...
    #mataAnggaranTable .badge.badge-success {
        background-color: #dff3e1 !important;
        color: #2e7d32 !important;
        border: 1px solid #c8e6c9;
    }
    #mataAnggaranTable .badge.badge-danger {
    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Data Master &raquo; Manajemen M. Anggaran</h3>
                <div class="card-tools">
                    <a href="{{ route('master.mata-anggaran.create') }}" class="btn btn-success btn-sm">
                    ...
                    <div class="input-group input-group-sm ml-2" style="width: 220px;">
                        ...
                        <input type="text" id="searchBox" class="form-control" placeholder="kata kunci pencarian" aria-controls="mataAnggaranTable">
                    </div>
                </div>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <div class="table-responsive">
                    <table id="mataAnggaranTable" class="table table-bordered table-striped table-hover">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th width="120" class="text-center">Kode Mata Anggaran</th>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p id="modalKonfirmasiHapusMessage">Apakah Anda yakin ingin menghapus data M. Anggaran ini?</p>
...
<script>
    $(function () {
        var table = $('#mataAnggaranTable').DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": {
                "url": "{{ route('master.mata-anggaran.grid') }}",
                "type": "GET",
            ...
            "columns": [
                ...
                { "data": "kode_mata_anggaran", "className": "text-center" },
                { "data": "nama_mata_anggaran" },
                {
                    "data": "status_mata_anggaran",
                    "className": "text-center",
                ...
                },
                {
                    ...
                    "width": "90",
                    "render": function (data) {
                        var editUrl = '{{ url("admin/master/m-anggaran/edit") }}/' + data;
                        var deleteUrl = '{{ url("admin/master/m-anggaran/delete") }}/' + data;
        ...
        $('#mataAnggaranTable tbody').on('change', '.checkItem', function () {
            var id = $(this).val();
            if (this.checked) {
                selectedIds.add(id);
            } else {
        ...
        $('#checkAll').on('change', function () {
            ...
            $('#mataAnggaranTable tbody .checkItem').prop('checked', isChecked);
            syncCheckAllState();
        });

        // Terapkan ulang status pilihan setelah DataTables redraw
        table.on('draw', function () {
            $('#mataAnggaranTable tbody .checkItem').each(function () {
                var id = $(this).val();
        ...
        $(document).on('click', '#mataAnggaranTable .btn-hapus-satu', function (e) {
            e.preventDefault();
            var url = $(this).attr('href');
            $('#modalKonfirmasiHapusMessage').text(
                'Apakah Anda yakin ingin menghapus data M. Anggaran ini? ' +
    ...
    function hapusData() {
        ...
        $('#modalKonfirmasiHapusMessage').text(
            ...
            ' data M. Anggaran yang dipilih? Tindakan ini tidak dapat dibatalkan.'
        );
    ...
    $(document).on('click', '#btnKonfirmasiHapus', function () {
        ...
        if (mode === 'single') {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('master.mata-anggaran.delete') }}",
