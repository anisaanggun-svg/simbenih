...
@section("title", "Tambah Master Kecamatan - Data Master")
    ...
    <div class="col-md-8 offset-md-2">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Form Input Data Master Kecamatan</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                @if($errors->any())
                ...
                <div class="info mb-3">
                    <p class="text-muted">User melakukan pengisian form untuk menambah data kecamatan.</p>
                </div>
                ...
                <form action="{{ route('master.kecamatan.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="kode_kecamatan" id="kode_kecamatan"
                               ...
                               maxlength="10" placeholder="Contoh: 0001, 0002" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="kode_kecamatan_nasional" id="kode_kecamatan_nasional"
                               ...
                               value="{{ old('kode_kecamatan_nasional') }}"
                               maxlength="10" placeholder="Contoh: 130, 110" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_kecamatan" id="nama_kecamatan"
                               ...
                               placeholder="Contoh: Arosbaya, Bangkalan" required>
                    ...
                    <div class="form-group">
                        ...
                        <select name="kabupaten_id" id="kabupaten_id"
                            ...
                            <option value="0" {{ old('kabupaten_id', '0') == '0' ? 'selected' : '' }}>-- Pilih Kabupaten --</option>
                    ...
                    <div class="form-group">
                        ...
                        <select name="status_kecamatan" id="status_kecamatan"
                            ...
                            <option value="1" {{ old('status_kecamatan', '1') == '1' ? 'selected' : '' }}>Aktif</option>
                            <option value="0" {{ old('status_kecamatan') == '0' ? 'selected' : '' }}>Tidak Aktif</option>
                        </select>
