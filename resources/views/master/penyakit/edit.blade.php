...
@section("title", "Edit Master Penyakit - Data Master")
    ...
    <div class="col-md-8 offset-md-2">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Form Edit Data Master Penyakit</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                @if($errors->any())
                ...
                <div class="info mb-3">
                    <p class="text-muted">User melakukan pengisian form untuk mengubah data penyakit.</p>
                </div>
                ...
                <form action="{{ route('master.penyakit.update', $penyakit->id) }}" method="POST">
                    @csrf
                    <input type="hidden" name="kode_hidden" value="{{ $penyakit->kode_penyakit }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="kode_penyakit" id="kode_penyakit"
                               ...
                               maxlength="10" placeholder="Masukkan Kode Penyakit" required>
                    ...
                    <div class="form-group">
                        ...
                        <select name="kelompok_penyakit" id="kelompok_penyakit"
                            ...
                            @foreach(\App\Models\Penyakit::kelompokOptions() as $key => $label)
                                <option value="{{ $key }}" {{ old('kelompok_penyakit', $penyakit->kelompok_penyakit) == $key ? 'selected' : '' }}>{{ $label }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="ket_penyakit" id="ket_penyakit"
                               ...
                               value="{{ old('ket_penyakit', $penyakit->ket_penyakit) }}"
                    ...
                    <div class="form-group">
                        ...
                        <select name="status_penyakit" id="status_penyakit"
                            ...
                            <option value="1" {{ old('status_penyakit', $penyakit->status_penyakit) == '1' ? 'selected' : '' }}>Aktif</option>
                            <option value="0" {{ old('status_penyakit', $penyakit->status_penyakit) == '0' ? 'selected' : '' }}>Tidak Aktif</option>
                        </select>
