...
@section("title", "Permohonan Konsep Label Standart - Sertifikasi")
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Sertifikasi > Permintaan No Seri Label Standart > Daftar Data Rekomendasi Benih</h3>
                <div class="card-tools">
                    <a href="{{ url('') }}/admin/sertifikasi/label_standart" class="btn btn-secondary btn-sm">
                        <i class="fas fa-arrow-left"></i> Kembali ke Daftar Konsep Label Standart
                    </a>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center action-buttons">
                                    <a href="{{ $row->input ?? '#' }}" class="btn btn-xs btn-success" title="Input Konsep Label Standart">
                            ...
                            <tr>
                                <td colspan="7" class="text-center py-4">
                                    <div class="text-muted">
                                        ...
                                        <p class="mb-0">Belum ada data permohonan konsep label standart.</p>
                                    </div>
                                </td>
                            </tr>
                            @endforelse
