...
@section("title", "Tambah Master Varietas - Data Master")
    ...
    <div class="col-md-10 offset-md-1">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Form Input Data Master Varietas</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                @if($errors->any())
                ...
                <div class="info mb-3">
                    <p class="text-muted">User melakukan pengisian form untuk menambah data varietas.</p>
                </div>
                ...
                <form action="{{ route('master.varietas.store') }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="jenis_tanaman_id" id="jenis_tanaman_id"
                                    ...
                                    @foreach($jenisTanamanList as $jenis)
                                        <option value="{{ $jenis->id }}" {{ old('jenis_tanaman_id') == $jenis->id ? 'selected' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <select name="status_varietas" id="status_varietas"
                                    ...
                                    <option value="Aktif" {{ old('status_varietas', 'Aktif') == 'Aktif' ? 'selected' : '' }}>Aktif</option>
                                    <option value="Tidak Aktif" {{ old('status_varietas') == 'Tidak Aktif' ? 'selected' : '' }}>Tidak Aktif</option>
                                </select>
