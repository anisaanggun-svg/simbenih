...
@section("title", "Edit Master Wilayah Kerja - Data Master")
    ...
    <div class="col-md-8 offset-md-2">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Form Edit Data Master Wilayah Kerja</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                @if($errors->any())
                ...
                <div class="info mb-3">
                    <p class="text-muted">User melakukan pengisian form untuk mengubah data Wilayah Kerja (Satgas).</p>
                </div>
                ...
                <form action="{{ route('master.wilayah-kerja.update', $wilayahKerja->id) }}" method="POST">
                    @csrf
                    <input type="hidden" name="kode_hidden" value="{{ $wilayahKerja->kode_satgas }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="kode_satgas" id="kode_satgas"
                               ...
                               value="{{ old('kode_satgas', $wilayahKerja->kode_satgas) }}"
                               min="0" max="255" placeholder="Masukkan Kode Wilayah Kerja" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_satgas" id="nama_satgas"
                               ...
                               value="{{ old('nama_satgas', $wilayahKerja->nama_satgas) }}"
                               placeholder="Masukkan Nama Wilayah Kerja" required>
                        @error('nama_satgas')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="status_satgas" id="status_satgas"
                            ...
                            <option value="1" {{ old('status_satgas', $wilayahKerja->status_satgas) == '1' ? 'selected' : '' }}>Aktif</option>
                            <option value="0" {{ old('status_satgas', $wilayahKerja->status_satgas) == '0' ? 'selected' : '' }}>Tidak Aktif</option>
                        </select>
                        @error('status_satgas')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
