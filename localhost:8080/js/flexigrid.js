		...
		if (p.searchitems)
			{
				...
				$(g.sDiv).append("<div class='sDiv2'>Cari Data <input type='text' size='30' name='q' class='qsbox' autocomplete='off' /> <select name='qtype'>"+sopt+"</select> <input type='button' value='Cari' /></div>");

				$('input[name=q],select[name=qtype]',g.sDiv).keydown(function(e){if(e.keyCode==13) g.doSearch()});
				$('input[value=Cari]',g.sDiv).click(function(){g.doSearch(); });
