...
@section("title", "Master Wilayah Kerja - Data Master")
...
<style>
    #wilayahKerjaTable th { white-space: nowrap; }
    #wilayahKerjaTable td { vertical-align: middle; padding: 8px 10px; }
    .card-tools {
        display: flex;
        gap: 0.5rem;
        flex-wrap: wrap;
    ...
    #wilayahKerjaTable .badge.badge-success {
        background-color: #dff3e1 !important;
        color: #2e7d32 !important;
        border: 1px solid #c8e6c9;
    }
    #wilayahKerjaTable .badge.badge-danger {
    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Data Master &raquo; Manajemen Wilayah Kerja</h3>
                <div class="card-tools">
                    <a href="{{ route('master.wilayah-kerja.create') }}" class="btn btn-success btn-sm">
                    ...
                    <div class="input-group input-group-sm ml-2" style="width: 220px;">
                        ...
                        <input type="text" id="searchBox" class="form-control" placeholder="kata kunci pencarian" aria-controls="wilayahKerjaTable">
                    </div>
                </div>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <div class="table-responsive">
                    <table id="wilayahKerjaTable" class="table table-bordered table-striped table-hover">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th width="120" class="text-center">Kode Wilayah Kerja</th>
...
<script>
    $(function () {
        var table = $('#wilayahKerjaTable').DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": {
                "url": "{{ route('master.wilayah-kerja.grid') }}",
                "type": "GET",
            ...
            "columns": [
                ...
                { "data": "kode_satgas", "className": "text-center" },
                { "data": "nama_satgas" },
                {
                    "data": "status_satgas",
                    "className": "text-center",
                ...
                },
                {
                    ...
                    "width": "90",
                    "render": function (data) {
                        var editUrl = '{{ url("admin/master/wilayah-kerja/edit") }}/' + data;
                        var deleteUrl = '{{ url("admin/master/wilayah-kerja/delete") }}/' + data;
        ...
        $('#wilayahKerjaTable tbody').on('change', '.checkItem', function () {
            var id = $(this).val();
            if (this.checked) {
                selectedIds.add(id);
            } else {
        ...
        $('#checkAll').on('change', function () {
            ...
            $('#wilayahKerjaTable tbody .checkItem').prop('checked', isChecked);
            syncCheckAllState();
        });

        // Terapkan ulang status pilihan setelah DataTables redraw
        table.on('draw', function () {
            $('#wilayahKerjaTable tbody .checkItem').each(function () {
                var id = $(this).val();
        ...
        $('#btnConfirmHapus').on('click', function () {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('master.wilayah-kerja.delete') }}",
