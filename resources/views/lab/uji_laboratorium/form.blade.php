                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        <td class="desc1" width="270">
                                            {{ $lhu->no_induk_lapangan ?? old('no_induk_lapangan', '-') }}
                                        </td>
                                        <td>&nbsp;</td>
                                        <td><label class="desc">No Berkas</label></td>
                                        <td>:&nbsp;</td>
                                        <td class="desc1">
                                            {{ $lhu->no_berkas ?? old('no_berkas', '-') }}
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>:&nbsp;</td>
                                        <td class="desc1" width="270">
                                            {{ $lhu->nama_produsen ?? old('nama_produsen', '-') }}
                                        </td>
                                        <td>&nbsp;</td>
                                        <td><label class="desc">Alamat</label></td>
                                        <td>:&nbsp;</td>
                                        <td class="desc1">
                                            {{ $lhu->alamat_produsen ?? old('alamat_produsen', '-') }}
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>:&nbsp;</td>
                                        <td class="desc1">
                                            {{ $lhu->no_asal ?? old('no_asal', '-') }}
                                        </td>
                                        <td>&nbsp;</td>
                                        <td><label class="desc">NO LAB</label></td>
                                        <td>:&nbsp;</td>
                                        <td class="desc1">
                                            {{ $lhu->no_lab ?? old('no_lab', '-') }}
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>:&nbsp;</td>
                                        <td class="desc1">
                                            {{ $lhu->jenis_tanaman ?? old('jenis_tanaman', '-') }}
                                        </td>
                                        <td>&nbsp;</td>
                                        <td><label class="desc">Varietas</label></td>
                                        <td>:&nbsp;</td>
                                        <td class="desc1">
                                            {{ $lhu->varietas ?? old('varietas', '-') }}
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>:&nbsp;</td>
                                        <td class="desc1">
                                            {{ $lhu->kelas_benih ?? old('kelas_benih', '-') }}
                                        </td>
                                        <td>&nbsp;</td>
                                        <td><label class="desc">No LOT</label></td>
                                        <td>:&nbsp;</td>
                                        <td class="desc1">
                                            {{ $lhu->no_lot ?? old('no_lot', '-') }}
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>:&nbsp;</td>
                                        <td class="desc1">
                                            {{ isset($lhu) && $lhu->tgl_panen_awal ? \Carbon\Carbon::parse($lhu->tgl_panen_awal)->format('d-m-Y') : (old('tgl_panen_awal') ? \Carbon\Carbon::parse(old('tgl_panen_awal'))->format('d-m-Y') : '-') }}
                                        </td>
                                        <td>&nbsp;</td>
                                        <td><label class="desc">Luas Lulus Terakhir</label></td>
                                        <td>:&nbsp;</td>
                                        <td class="desc1">
                                            {{ $lhu->luas_lulus ?? old('luas_lulus', '-') }}
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>:&nbsp;</td>
                                        <td class="desc1">
                                            {{ isset($lhu) && $lhu->tgl_panen_akhir ? \Carbon\Carbon::parse($lhu->tgl_panen_akhir)->format('d-m-Y') : (old('tgl_panen_akhir') ? \Carbon\Carbon::parse(old('tgl_panen_akhir'))->format('d-m-Y') : '-') }}
                                        </td>
                                        <td>&nbsp;</td>
                                        <td><label class="desc">Tonase Kelompok Benih</label></td>
                                        <td>:&nbsp;</td>
                                        <td class="desc1">
                                            {{ $lhu->tonase ?? old('tonase', '-') }} Kilogram
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>:&nbsp;</td>
                                        <td class="desc1">
                                            {{ isset($lhu) && $lhu->tgl_selesai_pengujian ? \Carbon\Carbon::parse($lhu->tgl_selesai_pengujian)->format('d-m-Y') : (old('tgl_selesai_pengujian') ? \Carbon\Carbon::parse(old('tgl_selesai_pengujian'))->format('d-m-Y') : '-') }}
                                        </td>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                ...
                                <td width="50%">
                                    <ul>
                                        <li class="hasil-ujian">
                                            ...
                                            <div class="desc1">: {{ $lhu->kadar_air ?? old('kadar_air', '-') }} %</div>
                                        </li>
                                        <li class="hasil-ujian">
                                            <label>Benih Murni</label>
                                            <div class="desc1">: {{ $lhu->benih_murni ?? old('benih_murni', '-') }} %</div>
                                            @if(!isset($mode) || $mode != 'lihat')
                                                <input type="text" class="form-control form-control-sm d-inline-block ml-2" width="3"
                                                       name="benih_murni" id="benih_murni"
                                                       value="{{ $lhu->benih_murni ?? old('benih_murni') }}"
                                                       style="width: 80px;">
                                            @endif
                                        </li>
                                        <li class="hasil-ujian">
                                            <label>Kotoran Benih</label>
                                            <div class="desc1">: {{ $lhu->kotoran_benih ?? old('kotoran_benih', '-') }} %</div>
                                            @if(!isset($mode) || $mode != 'lihat')
                                                <input type="text" class="form-control form-control-sm d-inline-block ml-2"
                                                       name="kotoran_benih" id="kotoran_benih"
                                                       value="{{ $lhu->kotoran_benih ?? old('kotoran_benih') }}"
                                                       style="width: 80px;">
                                            @endif
                                        </li>
                                        <li class="hasil-ujian">
                                            <label>BTL/Gulma</label>
                                            <div class="desc1">: {{ $lhu->btl_gulma ?? old('btl_gulma', '-') }} %</div>
                                            @if(!isset($mode) || $mode != 'lihat')
                                                <input type="text" class="form-control form-control-sm d-inline-block ml-2"
                                                       name="btl_gulma" id="btl_gulma"
                                                       value="{{ $lhu->btl_gulma ?? old('btl_gulma') }}"
                                                       style="width: 80px;">
                                            @endif
                                        </li>
                                    </ul>
                                ...
                                <td>
                                    <ul>
                                        <li class="hasil-ujian">
                                            ...
                                            <div class="desc1">: {{ $lhu->daya_berkecambah ?? old('daya_berkecambah', '-') }} %</div>
                                        </li>
                                        <li class="hasil-ujian">
                                            <label>Biji Keras</label>
                                            <div class="desc1">: {{ $lhu->biji_keras ?? old('biji_keras', '-') }} %</div>
                                        </li>
                                        <li class="hasil-ujian">
                            ...
                            <tbody>
                                <tr>
                                    <td width="50%" valign="top">
                                        <ul>
                                            <li class="form-group">
                                                <label for="no_induk_lhu">Nomor Induk LHU</label>
                                                <input type="text" class="form-control" name="no_induk_lhu" id="no_induk_lhu"
                                                       value="{{ $lhu->no_induk_lhu ?? old('no_induk_lhu') }}"
                                                       {{ isset($mode) && $mode == 'lihat' ? 'readonly' : '' }}>
                                            </li>
                                            <li class="form-group">
                                                <label for="nama_produsen">Nama Produsen</label>
                                                <select name="nama_produsen" id="nama_produsen" class="form-control select2" style="width:100%;" {{ isset($mode) && $mode == 'lihat' ? 'disabled' : '' }} onchange="dapatkan_alamat()">
                                                    <option value="">-- Pilih Produsen --</option>
                                                    @foreach($produsen_list as $p)
                                                        <option value="{{ $p->id }}"
                                                                {{ (isset($lhu) && $lhu->nama_produsen == ($p->nama_produsen ?? $p->nama)) || old('nama_produsen') == ($p->nama_produsen ?? $p->nama) ? 'selected' : '' }}>
                                                                    {{ $p->nama_produsen ?? $p->nama }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </li>
                                            ...
                                            <li class="form-group">
                                                <label for="petugas_lhu">Petugas LHU</label>
                                                <select name="petugas_lhu" id="petugas_lhu" class="form-control select2" style="width:100%;" {{ isset($mode) && $mode == 'lihat' ? 'disabled' : '' }}>
                                                    <option value="">-- Pilih Pegawai --</option>
                                                    @foreach($pegawai_list as $peg)
                                                        <option value="{{ $peg->id }}"
                                                                {{ (isset($lhu) && $lhu->petugas_lhu == $peg->id) || old('petugas_lhu') == $peg->id ? 'selected' : '' }}>
                                                                    {{ $peg->nama }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <td>
                                        <ul>
                                            <li class="form-group">
                                                ...
                                                <textarea class="form-control" name="alamat_produsen" id="alamat_produsen" rows="4" readonly>{{ $lhu->alamat_produsen ?? old('alamat_produsen') }}</textarea>
                                            </li>
                                            <li class="form-group">
                                                <label>Kesimpulan</label>
                                                <div class="radio-group">
                                                    <div class="custom-control custom-radio">
                                                        <input class="custom-control-input" type="radio" name="kesimpulan" id="kesimpulan_1" value="1"
                                                    ...
                                                    <div class="custom-control custom-radio">
                                                        <input class="custom-control-input" type="radio" name="kesimpulan" id="kesimpulan_0" value="0"
...
@push("script")
<script>
    var no_induk_pengajuan = '{{ isset($lhu) ? $lhu->no_induk_lapangan : old('no_induk_lapangan', '') }}';
    var sp = no_induk_pengajuan.split('.');
    var no_induk = '{{ isset($lhu) ? $lhu->no_induk_lapangan : old('no_induk_lapangan', '') }}';
    ...
    function set_disable() {
        for (var i = 0; i < document.form_lhu.kesimpulan.length; i++) {
            if (document.form_lhu.kesimpulan[i].checked) {
                var rad_val = document.form_lhu.kesimpulan[i].value;
                if (rad_val == '0') {
